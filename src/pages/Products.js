...
function Products() {
  ...
  return (
    <div className="tamsayfa">
      <h1>UYARI !</h1>
      <h1>Tüm ürünlerimizi asagida bulabilirsiniz.</h1>
      <h1>
        Ürünleri satin almak icin lütfen iletisim sayfamizdan Süpervisörlerimiz
        ile iletisime geciniz.
      </h1>
      {Products.map((item) => (
        <div className="produkt">
          <img src={item.url} alt="herbalife" />
